  ...
  return (
    <div className="App">
      <header>
        ...
        {config.debug && <div className="debug-banner">Debug Mode Enabled</div>}
      </header>
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              {config.sentry.enabled ? "Enabled" : "Disabled"}
            </li>
            <li>
              Google Analytics:{" "}
            ...
            <li>
              Redux DevTools: {config.reduxDevTools ? "Enabled" : "Disabled"}
            </li>
          </ul>
        </section>
      </main>
